...
plots for the 6 A0V100 relaxation tests (all held at ~0.5 mm). Tests 1-3
ramp at the baseline rate (~0.167 mm/s); tests 4-6 ramp at ~10x that rate
(~1.62 mm/s) -- three replicates per rate.
...
TESTS = {
    ...
    4: ("Fast rate (1.62 mm/s)", 0),
    5: ("Fast rate (1.62 mm/s)", 1),
    6: ("Fast rate (1.62 mm/s)", 2),
}
