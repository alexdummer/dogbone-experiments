"""Stress-vs-strain plot for the A50V50 relaxation tests, all loading rates
overlaid on a single axis, restricted to the 2 mm-hold retest series (see
plot_stress_time.py for the rate-group/replicate structure and the test-16
outlier note) and to the loading ramp itself -- the hold/relaxation phase
