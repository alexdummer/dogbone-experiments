"""Concatenate the raw chunks of each A50V50 retest (variable number of
_N continuation chunks), extract time, position, force, and strain, and
zero position/force/strain against the pre-ramp baseline (before position
